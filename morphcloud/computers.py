...
class Browser:
    ...
    async def connect(self, timeout_seconds: int = 30):
        ...
        try:
            ...
            print(f"Using WebSocket URL: {browser_ws_endpoint}")
    ...
    async def forward(self, timeout: int = 10000, wait_until: str = "domcontentloaded") -> None:
        ...
        try:
            await self._ensure_connected()
            print("Going forward in history")
...
class Sandbox:
    ...
    async def _ensure_kernel_connection(self):
    ...
    async def connect(self, timeout_seconds=30, kernel_id=None):
    ...
    async def execute_code(self, code: str, timeout=30) -> Dict[str, Any]:
        """
    ...
    async def add_cell(self, notebook_path: str, content: str, cell_type: str = "code"):
        """
...
class Computer(Instance):
    ...
    def cdp_url(self) -> str:
        ...
        for service in self.networking.http_services:
            if service.name == "web":
                return service.url
        # If CDP is not already exposed, expose it
        return None
    ...
    def key_press_special(self, keys: list) -> None:
        """
    ...
    async def akey_press_special(self, keys: list) -> None:
